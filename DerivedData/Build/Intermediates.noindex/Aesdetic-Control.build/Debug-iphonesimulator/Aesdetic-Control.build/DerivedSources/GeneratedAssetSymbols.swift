...
extension DeveloperToolsSupport.ImageResource {
    ...
    static let aesdeticLogo = DeveloperToolsSupport.ImageResource(name: "aesdetic_logo", bundle: resourceBundle)
...
extension AppKit.NSImage {
    ...
    /// The "aesdetic_logo" asset catalog image.
    static var aesdeticLogo: AppKit.NSImage {
#if !targetEnvironment(macCatalyst)
        .init(resource: .aesdeticLogo)
#else
        .init()
#endif
    }
...
extension UIKit.UIImage {
    ...
    /// The "aesdetic_logo" asset catalog image.
    static var aesdeticLogo: UIKit.UIImage {
#if !os(watchOS)
        .init(resource: .aesdeticLogo)
#else
        .init()
